const courses = {
  ...
  listOfCourses: [
    ...
    // 3rd course and so on...
    {
      ...
      description:
        "Become a full-stack web developer with hands-on experience in both frontend and backend technologies.",
      enrollmentStatus: "Open",
      thumbnail: "your.image.here",
      duration: "12 weeks",
      ...
      syllabus: [
        {
          ...
          content:
            "Overview of frontend and backend technologies, setting up your development environment.",
        },
        {
          week: 2,
          topic: "Building a Responsive Web App",
          content:
            "Creating a responsive web application using modern frontend frameworks.",
        },
        // Additional weeks and topics...
      ],
      students: [
    ...
    // 4th course
    {
      ...
      description:
        "Explore the world of data science using the Python programming language.",
      enrollmentStatus: "Open",
      thumbnail: "your.image.here",
      duration: "10 weeks",
      ...
      syllabus: [
        {
          ...
          content:
            "Overview of the Python programming language, setting up your Python environment.",
        },
        {
          week: 2,
          topic: "Data Manipulation with Pandas",
          content:
            "Learn how to manipulate and analyze data using the Pandas library.",
        },
        // Additional weeks and topics...
      ],
      students: [
      ...
      syllabus: [
        {
          ...
          content:
            "Overview of mobile app design principles and introduction to the Figma tool.",
        },
        {
          week: 2,
          topic: "Wireframing and Prototyping",
          content:
            "Create wireframes and interactive prototypes for your mobile app.",
        },
        // Additional weeks and topics...
      ],
      students: [
    ...
    },
    {
      ...
      description:
        "Dive into the fundamentals of machine learning and understand its practical applications.",
      enrollmentStatus: "Open",
      ...
      syllabus: [
        {
          ...
          content:
            "Overview of machine learning, types of machine learning, and basic concepts.",
        },
        {
          week: 2,
    ...
    // 7th course
    {
      ...
      description:
        "Explore the essential concepts of cybersecurity and learn to secure digital assets.",
      enrollmentStatus: "Open",
      thumbnail: "your.image.here",
      duration: "10 weeks",
      ...
      syllabus: [
        ...
        },
        {
          ...
          content:
            "Securing computer networks and understanding network vulnerabilities.",
        },
        // Additional weeks and topics...
      ],
      students: [
    ...
    // 8th course
    {
      ...
      description:
        "Learn to create stunning data visualizations using the D3.js library.",
      enrollmentStatus: "Open",
      thumbnail: "your.image.here",
      duration: "8 weeks",
      ...
      syllabus: [
        {
          ...
          content:
            "Overview of data visualization, importance, and types of visualizations.",
        },
        {
          week: 2,
          topic: "Getting Started with D3.js",
          content:
            "Setting up D3.js, creating basic visualizations, and understanding data binding.",
        },
        // Additional weeks and topics...
      ],
      students: [
    ...
    // 9th course
    {
      ...
      description:
        "Master the art of iOS app development using the Swift programming language.",
      enrollmentStatus: "Open",
      thumbnail: "your.image.here",
      duration: "10 weeks",
      ...
      syllabus: [
        {
          ...
          content:
            "Overview of iOS development, Xcode setup, and creating your first iOS app.",
        },
        {
          week: 2,
          topic: "Building User Interfaces with Swift",
          content:
            "Designing and implementing user interfaces using Swift and Interface Builder.",
        },
        // Additional weeks and topics...
      ],
      students: [
    ...
    // 10th course
    {
      ...
      syllabus: [
        ...
        },
        {
          ...
          content:
            "Introduction to popular frontend frameworks like React and Vue.",
        },
        // Additional weeks and topics...
      ],
      students: [
